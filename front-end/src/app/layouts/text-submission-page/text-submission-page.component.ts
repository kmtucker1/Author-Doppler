...
@Component({
  selector: 'app-text-submission-page',
  templateUrl: './text-submission-page.component.html',
  styleUrls: ['./text-submission-page.component.css']
})
export class TextSubmissionPageComponent implements OnInit {

  constructor(private apiService: TempApiService) { }


  writingPromptList: String[] = [
  ...
  ngOnInit(): void {
    ...
    this.textForm.valueChanges.subscribe((value) => {this.text = value.text; this.wordCounter()})
  }


  sendTextToService() {
    this.apiService.setText(this.text);
  }
  ...
  getRandomWritingPrompt() {
    this.writingPrompt = this.writingPromptList[Math.floor(Math.random() * 351)];
  }
}
